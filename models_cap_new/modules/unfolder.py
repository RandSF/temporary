...
class Unfolder(nn.Module):
    ...
    def forward(self, feat_blur, feat_pyramid):
        ...
        joint_img_e1 = soft_argmax_2d(pred_heatmap_e1.reshape(-1, self.num_joints, *self.output_hm_shape))
        joint_img_md = soft_argmax_2d(pred_heatmap_md.reshape(-1, self.num_joints, *self.output_hm_shape))
        joint_img_e2 = soft_argmax_2d(pred_heatmap_e2.reshape(-1, self.num_joints, *self.output_hm_shape))
